...
class GeneratePageFixturesCommand extends GenerateFixtureCommand
{
    protected function configure() {
        $this->setName('stef:fixture:generate:bv-page');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->generatorSettings->set('entity_classname', 'Page');
